...
HD_PWD='C:/Users/Oyama Plati/Downloads/EEE2020/EEE4120F/FPGA/projects/my_first_project/my_first_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_first_project.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_first_project.tcl -notrace
