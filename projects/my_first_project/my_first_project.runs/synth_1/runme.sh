...
HD_PWD='C:/Users/Oyama Plati/Downloads/EEE2020/EEE4120F/FPGA/projects/my_first_project/my_first_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_first_project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_first_project.tcl
